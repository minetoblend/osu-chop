...
public partial class ChopPlayfieldAdjustmentContainer : PlayfieldAdjustmentContainer
{
    ...
    public ChopPlayfieldAdjustmentContainer()
    {
    ...
    private partial class ScalingContainer : Container
    {
        ...
        protected override void Update()
        {
            ...
            // Scale = 819.2 / 512
            // Scale = 1.6
            Scale = new Vector2(Parent!.ChildSize.X / ChopPlayfield.BASE_SIZE.X);
